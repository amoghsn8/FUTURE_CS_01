...
This repository contains the deliverables for Task 1 of the Future Interns Cybersecurity Internship, which involved performing a read-only vulnerability assessment on a publicly accessible web application.
...
* Server Information Disclosure via X-Powered-By header
...
This assessment was conducted strictly for educational and training purposes as part of the Future Interns cybersecurity internship program.
